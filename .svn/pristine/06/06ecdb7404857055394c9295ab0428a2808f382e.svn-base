package com.sb.framework.rubbish;
 ...
 * 2014-4-13 1:28:59
 */
public class SBObjectCache {
	private HashMap<String, SoftReference> data;
	
	public SBObjectCache() {
	...
	public <T> boolean recycle(T object) {
		try {
			data.put(System.currentTimeMillis()+"-rubbish", new SoftReference<T>(object));
			return true;
		} catch (Exception e) {		}
		return false;
	}
